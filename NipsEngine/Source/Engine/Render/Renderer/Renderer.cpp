...
void FRenderer::InitializePassRenderStates()
{
	...
	S[(uint32)E::Billboard]          = { EDepthStencilState::DepthReadOnly,      EBlendState::AlphaBlend,     ERasterizerState::SolidNoCull,    D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST, &Resources.BillboardShader,      true  };
